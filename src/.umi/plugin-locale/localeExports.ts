...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/Volumes/dev/8thinkHR5/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/Volumes/dev/8thinkHR5/node_modules/warning/warning.js';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Volumes/dev/8thinkHR5/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Volumes/dev/8thinkHR5/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Volumes/dev/8thinkHR5/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Volumes/dev/8thinkHR5/src/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
    antd: {
