// @ts-nocheck
/**
 * Base on https://github.com/umijs//Volumes/dev/8thinkHR5/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/Volumes/dev/8thinkHR5/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/Volumes/dev/8thinkHR5/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/Volumes/dev/8thinkHR5/node_modules/@ahooksjs/use-request/lib/types';
